...
const faqs = [
  {
    question: "Is Aditya Sir, Qualified and Verified ?",
    answer: [
      ...
      "Have more questions? Reach out to us on Whatsapp or call +91 9334454757.",
    ],
  },
  {
    question:
      "What is the Process of Hiring Adiyta Sir?",
    answer: [
      "Hiring Aditya Sir is simple, quick, and fully personalized to your academic needs. We follow a step-by-step process to ensure you get the best tutor for your child’s learning goals, curriculum, and schedule.",
      "1. Submit an Inquiry",
      "Start by contacting us through our website www.adityasir.in, email (info@adityasir.in), or WhatsApp/call at +91 9334454757. Share your details including:",
      ...
      "6. Why Choose Aditya Sir?",
      "• Highly qualified and verified tutor",
      ...
      "Ready to get started? Contact us today at info@adityasir.in or +91 9334454757 to book your free demo class!",
    ],
  },
  {
    question:
      "What is the Payment / Fee Paying System for Hired Online Private Tutors from www.adityasir.in?",
    answer: [
      "Aditya sir offer's a transparent, flexible, and secure payment system...",
      ...
      "Contact us at info@adityasir.in or WhatsApp +91 9334454757 for support.",
    ],
  },
  {
    question: "What are the Terms and Conditions?",
    answer: [
      "By using www.adityasir.in and enrolling in our online tutoring services, you agree to the following terms and conditions. Please read them carefully before proceeding.",

      "1. Service Overview",
      "Aditya Sir provides personalized online tutoring for CBSE, ICSE, IGCSE, IB, and other international curricula across UAE, Qatar, UK, USA, Canada, Australia, and India.",
      ...
      "• Refunds are considered only in exceptional cases, at the discretion of Aditya Sir.",
      ...
      "• Aditya Sir is not responsible for technical issues on the student’s side.",
      ...
      "• Aditya Sir provides the best support possible but does not guarantee specific academic results.",
  ...
  },
  {
    ...
    answer: [
      "Please read the following important guidelines carefully before starting your tutoring sessions with Aditya Sir. These policies are in place to ensure transparency, quality, and a smooth learning experience.",

      "1. No Direct Fee Transfers to Tutors",
      "• All payments must be made directly to Aditya Sir  via approved channels only.",
      "• Direct transactions with tutors are strictly prohibited.",
      "• If any direct fee payment is made to a tutor without our knowledge and any misalignment, fraud, or issue occurs, Aditya Sir  and its authorized personnel are not responsible.",
      ...
      "• Refunds are only provided in exceptional cases and are at the sole discretion of Aditya Sir.",
      ...
      "• All personal and academic information shared with Aditya Sir  is strictly confidential and used solely for tutoring purposes.",
    ],
  },
];
